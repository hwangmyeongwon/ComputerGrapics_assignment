...
var render = function() {
    ...
    modelMatrix=mult(modelMatrix,translate(theta[Base_X],0,theta[Base_Z],0));
    modelMatrix=mult(modelMatrix,rotate(theta[Base_ROTATE],0,1,0));
    base(modelMatrix);
