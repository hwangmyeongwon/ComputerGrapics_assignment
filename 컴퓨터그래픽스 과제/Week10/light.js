...
function setLighting(program){
    ...
    var matSpecular=[1.0,0.0,1.0,1.0]; //어떤 성분이 ambient,diffuse,specular 냄
    var matShininess=100.0; //하이라이트 영역을 넓히냐 좁히냐
    ...
    gl.uniform3f(attenLoc,1.0,1.0,1.0); //값이 생길수록 어두워짐(감쇄현상 공식에 의해)
