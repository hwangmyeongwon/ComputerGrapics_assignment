...
window.onload = function init()
{
    ...
    viewMatrix = lookAt(vec3(0.0, 0.0, 1.0), vec3(0.0, 0.0, 0.0), vec3(0.0, 1.0, 0.0));
...
function setTexture() {
    ...
    // gl.uniform1i(gl.getUniformLocation(program, "textrue0"), 0);
    ...
    image2.src = "../images/monalisa.bmp"
